class Project {
    ...
    getListItem() {
        ...
        let stargazers = '<a href="#" class="pinned-repo-meta muted-link stargazers-link"><svg aria-label="stars" class="octicon octicon-star" viewBox="0 0 14 16" version="1.1" width="14" height="16" role="img">';
        ...
        let network = '<a href="#" class="pinned-repo-meta muted-link network-link"><svg aria-label="forks" class="octicon octicon-repo-forked" viewBox="0 0 10 16" version="1.1"width="10" height="16" role="img">';
